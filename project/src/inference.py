...
from data.label_transforms import label_scaling, label_to_tensor
...
def main():
    ...
    model = Model()
    model.load_weights(
        "./outputs/unnormalised/model_epochs25_loss162038.4062_val-loss243631.0156_1717439475669035715.weights.h5"
    )
